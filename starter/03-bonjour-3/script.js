...
Quand l'événement se déclenche, JavaScript crée un objet Event qui peut être utilisé par la fonction. L'objet Event :
	- a notamment la propriété currentTarget, qui reseigne la cible de l'événement (c.-à-d. l'élément qui a déclenché la fonction) ;
	- est fourni à la fonction sous la forme d'un paramètre (qu'on appelle souvent e, ou event).
*/

/* EXERCICE 3bis :
- recopie le code de l'exercice 3 et ajoute une ligne dans la fonction direBonjour qui affcihe dans la console la valeur de currentTarget ; 
...
C'est une notion IMPORTANTE, essentielle, très très souvent utilisée dasn la programmation événementielle.
*/
